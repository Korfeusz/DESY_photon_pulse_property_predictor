...
if __name__ == '__main__':
    ...
    for run_number in run_numbers:
        ...
        np.save('preprocessed_data/beam_profiles_run_{}_raw'.format(run_number), beam_profiles_raw)
        np.save('preprocessed_data/beam_profiles_run_{}'.format(run_number), beam_profiles)
