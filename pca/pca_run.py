...
def plot_scatter(principal_components, labels, axes=(0, 1), title=None, sort_colors=False):
    n = len(set(labels))
...
if __name__ == '__main__':
    ...
    plot_scatter(principal_components, predictions, axes=(0, 1), title='PCA with predicted circularity labels')
    ...
    plot_scatter(principal_components, undulator_labels, axes=(0, 1), title='PCA with undulator number', sort_colors=True)
    ...
    plot_scatter(principal_components, electron_bunch_charge_labels, axes=(0, 1), title='PCA with electron bunch charges')
    ...
    plot_scatter(principal_components, energy_labels, axes=(0, 1), sort_colors=True, title='PCA with energies')
